...
<body id="page-top" class="index">
	...
	<div class="container">
		...
		<div class="navbar-header page-scroll">
			...
			<a class="navbar-brand page-scroll" href="#page-top">Pagina
				Inicial</a>
		</div>
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a class="page-scroll" href="#portfolio">Produtos</a></li>
				<li><a class="page-scroll" href="#about">Processo</a></li>
				<li><a class="page-scroll" href="#team">Time</a></li>
				<li><a class="page-scroll" href="#contact">Contate-nos</a></li>
			</ul>
		</div>
		<!-- /.navbar-collapse -->
	</div>
	...
	<div class="container">
		<div class="intro-text">
			<div class="intro-lead-in">Bem Vindo Ao Copo Feito!</div>
			<div class="intro-heading">Onde Sua Ideia Vira Lembranças</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 text-center">
				...
				<h3 class="section-subheading text-muted">Conheça nossas formas
					de trabalho</h3>
			</div>
		</div>
		<div class="row text-center">
			<div class="col-md-4">
				...
				<p class="text-muted">Com um sistema único de personalização de
					copos você poderá criar lembranças incriveis para quem você gosta.</p>
			</div>
			<div class="col-md-4">
				<span class="fa-stack fa-4x"> <i
					class="fa fa-circle fa-stack-2x text-primary"></i> <i
				...
				<p class="text-muted">Você pode usar alguma de nossas fotos
					padrão para utilizar em seus copos.</p>
			</div>
			<div class="col-md-4">
				<span class="fa-stack fa-4x"> <i
					class="fa fa-circle fa-stack-2x text-primary"></i> <i
				...
				<p class="text-muted">Para presentear quem você mais gosta, com
					uma imagem especial, temos a opção de utilizar uma imagem de sua
					preferência.</p>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 text-center">
				...
				<h3 class="section-subheading text-muted">Com copos de 300ml,
					600ml e 900ml (colocar uma ideia legal aqui, estava sem na hora)</h3>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-md-4 col-sm-6 portfolio-item">
				<a href="#portfolioModal3" class="portfolio-link"
					...
					</div> <img src="bootstrap/img/portfolio/treehouse.png"
					class="img-responsive" alt="">
				</a>
				<div class="portfolio-caption">
			...
			<div class="col-md-4 col-sm-6 portfolio-item">
				<a href="#portfolioModal4" class="portfolio-link"
					...
					</div> <img src="bootstrap/img/portfolio/golden.png"
					class="img-responsive" alt="">
				</a>
				<div class="portfolio-caption">
			...
			<div class="col-md-4 col-sm-6 portfolio-item">
				<a href="#portfolioModal5" class="portfolio-link"
					...
					</div> <img src="bootstrap/img/portfolio/escape.png"
					class="img-responsive" alt="">
				</a>
				<div class="portfolio-caption">
			...
			<div class="col-md-4 col-sm-6 portfolio-item">
				<a href="#portfolioModal6" class="portfolio-link"
					...
					</div> <img src="bootstrap/img/portfolio/dreams.png"
					class="img-responsive" alt="">
				</a>
				<div class="portfolio-caption">
					<h4>Frete Grátis*</h4>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 text-center">
				...
				<h3 class="section-subheading text-muted">Conheca Nossa
					Política Para Compras No Site</h3>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-12">
				<ul class="timeline">
					<li>
						<div class="timeline-image">
							<img class="img-circle img-responsive"
								src="bootstrap/img/about/1.jpg" alt="">
						</div>
						<div class="timeline-panel">
							...
							<div class="timeline-body">
								<p class="text-muted">Com um login da nossa loja virtual,
									você tem acesso a página de usuários do site</p>
							</div>
						</div>
					</li>
					<li class="timeline-inverted">
						<div class="timeline-image">
							<img class="img-circle img-responsive"
								src="bootstrap/img/about/2.jpg" alt="">
						</div>
						<div class="timeline-panel">
							<div class="timeline-heading">
							...
							<div class="timeline-body">
								<p class="text-muted">Com acesso ao site, pode-se escolher
									os produtos sem ser necessário um Login</p>
							</div>
						</div>
					</li>
					<li>
						<div class="timeline-image">
							<img class="img-circle img-responsive"
								src="bootstrap/img/about/3.jpg" alt="">
						</div>
						<div class="timeline-panel">
							<div class="timeline-heading">
							...
							<div class="timeline-body">
								<p class="text-muted">Com uma ferramenta básica de edição de
									imagens, você pode mudar a cor, modelo e tamanho das imagens
									para o seu copo.</p>
							</div>
						</div>
					</li>
					<li class="timeline-inverted">
						<div class="timeline-image">
							<img class="img-circle img-responsive"
								src="bootstrap/img/about/4.jpg" alt="">
						</div>
						<div class="timeline-panel">
							<div class="timeline-heading">
								<h4>Upload de Imagens</h4>
							...
							<div class="timeline-body">
								<p class="text-muted">Se preferir você poderá utilizar uma
									imagem da sua galeria, para deixar o seu copo Único!</p>
							</div>
						</div>
					</li>
					<li class="timeline-panel">
						...
						<div class="timeline-panel">
							...
							<div class="timeline-body">
								<p class="text-muted">Após a escolha dos produtos, se não
									estiver logado, precisará logar-se para finalizar a sua compra.
									Não se preocupe, podemos realizar o seu cadastro na hora, sem
									perder os seus itens</p>
							</div>
						</div>
					</li>
					<li class="timeline-inverted">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-4">
				<div class="team-member">
					<img src="bootstrap/img/team/2.jpg"
		...
		<div class="col-lg-8 col-lg-offset-2 text-center">
			<p class="large text-muted">Todos os envolvidos nesse projeto
				estão cursando bacharel em ciencias da computação, como parte do
				curso desenvolvemos esse projeto.</p>
		</div>
	</div>
	</div>
	</section>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 text-center">
				...
				<h3 class="section-subheading text-muted">Envie-nos uma dúvida,
					crítica ou sugestão.</h3>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-12">
						...
						<div class="col-md-6">
							<div class="form-group">
								<input type="text" class="form-control" placeholder="Seu Nome *"
									id="name" required
									data-validation-required-message="Por Favor, Informe o seu Nome.">
								<p class="help-block text-danger"></p>
							</div>
							<div class="form-group">
								<input type="email" class="form-control"
									placeholder="Seu Email *" id="email" required
									data-validation-required-message="Por Favor, Informe o seu Email de Acesso.">
								<p class="help-block text-danger"></p>
							</div>
							<div class="form-group">
								<input type="tel" class="form-control"
									placeholder="Seu Telefone *" id="phone" required
									data-validation-required-message="Por Favor, Informe o seu Telefone.">
								<p class="help-block text-danger"></p>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<textarea class="form-control" placeholder="Sua Mensagem *"
									id="message" required
									data-validation-required-message="Por Favor, Informe a Menssagem."></textarea>
								<p class="help-block text-danger"></p>
							</div>
						</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-4">
				<span class="copyright">Copyright &copy; Copo Feito 2016®</span>
			</div>
			<div class="col-md-4">
				<ul class="list-inline social-buttons">
						...
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								...
								<img class="img-responsive img-centered"
									src="bootstrap/img/portfolio/roundicons-free.png" alt="">
						...
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								...
								<p class="item-intro text-muted">Lorem ipsum dolor sit amet
									consectetur.</p>
								<img class="img-responsive img-centered"
									src="bootstrap/img/portfolio/startup-framework-preview.png"
									alt="">
								<p>
						...
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								...
								<p class="item-intro text-muted">Lorem ipsum dolor sit amet
									consectetur.</p>
								<img class="img-responsive img-centered"
									src="bootstrap/img/portfolio/treehouse-preview.png" alt="">
								<p>
						...
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								...
								<p class="item-intro text-muted">Lorem ipsum dolor sit amet
									consectetur.</p>
								<img class="img-responsive img-centered"
									src="bootstrap/img/portfolio/golden-preview.png" alt="">
								<p>
						...
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								...
								<p class="item-intro text-muted">Lorem ipsum dolor sit amet
									consectetur.</p>
								<img class="img-responsive img-centered"
									src="bootstrap/img/portfolio/escape-preview.png" alt="">
								<p>
						...
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								...
								<p class="item-intro text-muted">Lorem ipsum dolor sit amet
									consectetur.</p>
								<img class="img-responsive img-centered"
									src="bootstrap/img/portfolio/dreams-preview.png" alt="">
								<p>
